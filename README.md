...
**Bivago** é um projeto de site de hospedagem baseado em sites famosos como "Airbnb" e "Trivago". O projeto permite que os usuários pesquisem por data e tipo de quarto, realizem a reserva de forma segura e acompanhem o status de sua hospedagem a dificuldade de comparar tipos de quartos e disponibilidade em tempo real com uma interface moderna, limpa e intuitiva.
...
👉 **[Acesse o Protótipo no Figma](https://www.figma.com/make/QNlXxUrFkQ3J4wECrnEOBE/Hotel-Booking-UI-Design?fullscreen=1&t=ch90EL1a7vU10gYO-1)**

---

## 📅 Backlog do Produto — Bivago

| ID | User Story | Prioridade | Épico | Sprint |
|:---|:---|:---:|:---:|:---:|
| #1 | Como usuário, desejo **visualizar a lista de hotéis disponíveis** para explorar opções de estadia. | Alta | E1 | 1 |
| #2 | Como usuário, desejo acessar a **página de detalhes do quarto** para ver fotos, comodidades e descrição antes de reservar. | Alta | E1 | 1 |
...
| #4 | Como usuário, desejo **selecionar datas de check-in e check-out** para verificar a disponibilidade real dos quartos. | Alta | E2 | 1 |
...
| #9 | Como cliente, desejo **receber um voucher de confirmação** após o pagamento para comprovar minha reserva. | Alta | E6 | 2 |
...
O stack tecnológico que planejo usar (poderá sofrer alterações)
...
Desenvolvido com ☕ e dedicação por **Matheus Dias**, Atualmente cursando Análise e Desenvolvimento de Sistemas na **Fatec**. 
<br>
Este projeto faz parte do meu portfólio de desenvolvimento e projetos de faculdade. Se você gostou da ideia do **Bivago**, sinta-se à vontade para entrar em contato ou acompanhar meus outros projetos!

[![LinkedIn](https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/matheusrpdias/) 
[![GitHub](https://img.shields.io/badge/GitHub-100000?style=for-the-badge&logo=github&logoColor=white)](https://github.com/matheussd1)
